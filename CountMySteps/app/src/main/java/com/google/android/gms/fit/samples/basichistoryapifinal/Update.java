...
/*
Used for updating the step count
 */
public class Update extends AppCompatActivity {
    ...
    /*
    Used for implementing the BuildClient for calling the SensorsAPI
     */
                    ...
                    .enableAutoManage(this, 0, new GoogleApiClient.OnConnectionFailedListener() {
                        ...
                        public void onConnectionFailed(ConnectionResult result) {
                            Log.i(TAG, "Google Play services connection failed. Cause: " +
                                    result.toString());
                            Snackbar.make(
                                    Update.this.findViewById(R.id.main_activity_view),
    ...
    /*
    Used for finding the datasources
     */
    ...
    /*
    Register a listener with the Sensors API.
     */
